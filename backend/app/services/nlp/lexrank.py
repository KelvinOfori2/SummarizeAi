...
def summarize_lexrank(text: str, ratio: float = 0.3) -> str:
    """
    LexRank summarizer — graph-based unsupervised approach using
    eigenvector centrality (similar to PageRank for sentences).
    """
